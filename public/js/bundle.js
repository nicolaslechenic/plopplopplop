...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2xhc2hmbGV4IiwiYSI6ImNrM3VkcTdiMjAzaHAzZ3Flc2VhOWtieDMifQ.LrSSwVxbz5SYTMXy6H_zYQ';
      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Logged in successfully!'); // Once logged in, returns de root page to user after 1.5s
  ...
  return regeneratorRuntime.async(function updateSettings$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:1337/api/v1/users/updateMyPassword' : 'http://127.0.0.1:1337/api/v1/users/updateMe';
          _context.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
            url: url,
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45637" + '/');
