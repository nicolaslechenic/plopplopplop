...
/* eslint-disable */
var stripe = Stripe('pk_test_pVJ4GMtSEo3Bkns9nkI4GtMk00mqYTs84F');
...
var signupForm = document.getElementById('signup-form'); // DELEGATION
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  (0, _updateSettings.updateSettings)(form, 'Your informations have been');
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42115" + '/');
